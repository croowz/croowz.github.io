...
import { DocumentIcon, EnvelopeIcon, ChevronRightIcon, IdentificationIcon, WrenchScrewdriverIcon } from '@heroicons/react/24/outline';
        ...
        <div className="absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-xl border border-gray-200 dark:border-gray-700 z-10">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronRightIcon className={`w-4 h-4 transition-transform ${activeSubmenu === 'contact' ? 'rotate-90' : ''}`} />
            </button>
