  ...
  return (
    <section className="text-center mb-12">
      <div className="mb-6">
        ...
        <h1 className="text-4xl font-bold mb-2">Ryan Cruz</h1>
      ...
      <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-400 whitespace-pre-line">
        {`Cybersecurity Engineer with ${yearsOfExperience} years of experience.
Currently building a CIAM solution for `}
        <a
